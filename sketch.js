...
function draw() {
  ...
  var energyCollision = Matter.SAT.collides(player.body,energytesting1.body);
  if (energyCollision.collided) {
...
function moveBackgroundFront() {
  energytesting1.body.position.x = energytesting1.body.position.x - 5;
  lighttesting1.body.position.x = lighttesting1.body.position.x - 5;
  lighttesting2.body.position.x = lighttesting2.body.position.x - 5;
}
